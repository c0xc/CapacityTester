...
- To learn more, keep reading. To start using CapacityTester now, download and try [CapacityTester for Linux](https://github.com/c0xc/CapacityTester/releases/latest/download/Capacity_Tester-x86_64.AppImage) (or [Windows](https://github.com/c0xc/CapacityTester/releases/latest/download/capacity-tester.exe)) now.
...
Direct [download for Linux](https://github.com/c0xc/CapacityTester/releases/latest/download/Capacity_Tester-x86_64.AppImage).
...
Direct [download for Windows](https://github.com/c0xc/CapacityTester/releases/latest/download/capacity-tester.exe).
The [zip archive](https://github.com/c0xc/CapacityTester/releases/latest/download/CapacityTester_Win7.zip) contains a couple of files, all of which should be extracted
